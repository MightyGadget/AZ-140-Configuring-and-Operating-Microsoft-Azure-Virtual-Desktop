...
1. In the **File share settings** section, next to the **Identity-based access** label, select the **Not configured** link.
1. In the **Enable an Identity-based access** section, in the rectangle labeled **Microsoft Entra Domain Services**, select **Set up**.
